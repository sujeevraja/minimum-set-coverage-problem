...
const ProblemInstance * Controller::getProblemInstance() const {
    return _problemInstance != nullptr ? _problemInstance.get() : nullptr;
}

void Controller::writeProblemData() const {
    if (_problemInstance == nullptr)
        return;
...
Solver * Controller::getSolver() {
    return _solver != nullptr
        ? _solver.get()
        : nullptr;
}

void Controller::addProblemDataToSolver() {
